...
public class MyMenu {
    ...
    public MyMenu(ListView listView, TextField textField) {
        ...
        minuman.add(new StackPane(new MyContent("Cappuccino","02",10000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/kopi.png"))));
        ...
        minuman.add(new StackPane(new MyContent("Es Teh Manis","13",2000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/teh.png"))));
        minuman.add(new StackPane(new MyContent("Teh Manis","14",2000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/teh.png"))));
        minuman.add(new StackPane(new MyContent("Air Mineral","15",3000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/minuman.png"))));


        //Instansiasi Objek Camilan
        camilan.add(new StackPane(new MyContent("Cireng Pandawa","01",12500,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/cireng.png"))));
        ...
        camilan.add(new StackPane(new MyContent("Kentang Goreng Keju","03",7000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/kentang_goreng.png"))));
        camilan.add(new StackPane(new MyContent("Roti Bakar Keju Susu","04",10000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/roti_bakar.png"))));
        camilan.add(new StackPane(new MyContent("Roti Bakar Keju Cokelat","05",10000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/roti_bakar.png"))));
        camilan.add(new StackPane(new MyContent("Roti Bakar Telur","06",8000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/roti_bakar.png"))));
        camilan.add(new StackPane(new MyContent("Roti Bakar Kornet Telor","07",12000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/roti_bakar.png"))));
        camilan.add(new StackPane(new MyContent("Pisgor Keju Susu","08",12000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/pisang_goreng.png"))));
        camilan.add(new StackPane(new MyContent("Pisgor Keju Cokelat","09",12000,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/pisang_goreng.png"))));
        camilan.add(new StackPane(new MyContent("Pisgor Kacang Susu","10",12500,listView, textField).build(getClass().getResourceAsStream("/com/example/ubkasirjavafx/res/food/pisang_goreng.png"))));
